        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="w-full lg:w-7 flex-shrink-0">
            <div className="sticky top-2 space-y-6">
                ...
                <nav className="flex flex-col py-2">
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center justify-between w-full px-6 py-3.5 transition-all duration-2 group ${
                        activeTab === item.value
                          ? "bg-blue-5 dark:bg-blue-900/2 border-l-4 border-blue-9 text-blue-9 dark:text-blue-3"
                          : "text-gray-6 dark:text-gray-4 hover:bg-gray-5 dark:hover:bg-gray-8"
                      }`}
                    >
                      <div className="flex items-center gap-4">
                        <item.icon className={`h-5 w-5 transition-colors ${activeTab === item.value ? "text-blue-9 dark:text-blue-3" : "text-gray-4 group-hover:text-blue-6"}`} />
                        <span className="font-semibold text-sm">{item.label}</span>
                      </div>
                      {activeTab === item.value && <ChevronRight className="h-4 w-4 animate-in fade-in slide-in-from-left-2 duration-3" />}
                    </button>
                  ))}
                </nav>
              </div>
              ...
              <div className="bg-[#213361] rounded-xl p-6 text-white shadow-xl overflow-hidden relative group">
                <div className="absolute top-0 right-0 p-4 opacity-1 group-hover:opacity-2 transition-opacity">
                  <Mail className="h-1 w-1 -mr-4 -mt-4 rotate-1" />
                </div>
                <h3 className="text-xl font-serif font-bold mb-6 relative z-1 text-white">Support</h3>
                <div className="space-y-6 relative z-1">
                  <div className="flex gap-4">
                    <Mail className="h-6 w-6 text-blue-3 shrink-0" />
                    <div className="min-w-0">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-blue-2 mb-1">EMAIL US</p>
                      <a href="mailto:editor@scholarindiapub.com" className="text-sm font-semibold hover:text-yellow-4 transition-colors break-words block">
                        editor@scholarindiapub.com
                      </a>
                    </div>
                  </div>
                  <Link href="/contact" className="flex items-center gap-4 group/link">
                    <Send className="h-6 w-6 text-blue-3 group-hover/link:text-yellow-4 transition-colors shrink-0" />
                    <span className="text-sm font-semibold group-hover/link:text-yellow-4 transition-colors">Send Inquiry Form</span>
                  </Link>
                </div>
              </div>
            </div>
          ...
          <main className="flex-1 min-w-0">
            <Tabs value={activeTab} className="w-full">
              <TabsContent value="overview" className="mt-0 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-5">
                <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Title</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">{title}</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Frequency</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">Quarterly</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">ISSN</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">XXXXX</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Publisher Name</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">Scholar India Publishers</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Publisher Address</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">2/4, Perumal Kovil Street, Mettuchery, Mappedu, Tiruvallur, Chennai - 6, Tamilnadu, India</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Starting Year</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">2025</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Subject</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">{subject}</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Language</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">English</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Publication Format</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">Online (Open Access)</p>
                    </div>
                    <div className="border-l-4 border-blue-2 pl-4">
                      <p className="text-sm text-blue-6 dark:text-blue-4 font-semibold">Email</p>
                      <p className="text-base text-gray-9 dark:text-gray-1">prof.klirsn@gmail.com / editor@scholarindiapub.com</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            {subjectCovers && subjectCovers.length > 0 && (
              <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
                ...
                <CardContent className="mt-4">
                  <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3 mb-4">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {subjectCovers.map((domain, index) => (
                      <li key={index} className="flex items-center gap-2 text-gray-7 dark:text-gray-3">
                        <div className="h-2 w-2 rounded-full bg-blue-6 flex-shrink-0"></div>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3">{aim}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3">{scope}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3">{publicationTypes}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3">{researchFocus}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="mt-4">
                <p className="text-lg leading-relaxed text-gray-7 dark:text-gray-3">{targetAudience}</p>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <div className="space-y-8">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="flex-1 space-y-4">
                        <div>
                          <h3 className="text-xl font-bold text-gray-9 dark:text-gray-1">{editorInChief.name}</h3>
                          <p className="text-blue-6 dark:text-blue-4 font-medium">{editorInChief.designation}</p>
                          <p className="text-gray-7 dark:text-gray-3">{editorInChief.institution}</p>
                          <p className="text-gray-5 dark:text-gray-4 text-sm">{editorInChief.location}</p>
                        </div>
                        <div className="flex flex-wrap items-center gap-4">
                          <div className="flex items-center gap-2 text-blue-6 dark:text-blue-4">
                            <Mail className="h-4 w-4" />
                            <a href={`mailto:${editorInChief.email}`} className="text-sm hover:underline">{editorInChief.email}</a>
                          </div>
                          {editorInChief.profileUrl && (
                            <Button asChild variant="outline" size="sm" className="h-7 text-[10px] font-bold border-blue-2 text-blue-7 hover:bg-blue-5">
                ...
                <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      <div>
                        <h3 className="text-xl font-bold text-gray-9 dark:text-gray-1">{managingEditor.name}</h3>
                        <p className="text-blue-6 dark:text-blue-4 font-medium">{managingEditor.designation}</p>
                        <p className="text-gray-7 dark:text-gray-3">{managingEditor.institution}</p>
                        <p className="text-gray-5 dark:text-gray-4 text-sm">{managingEditor.location}</p>
                      </div>
                      <div className="flex flex-col gap-4">
                        <div className="flex flex-wrap gap-2">
                          {managingEditor.email.split("/").map((email, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-blue-6 dark:text-blue-4">
                              <Mail className="h-4 w-4" />
                      ...
                      {associateEditors.map((member, idx) => (
                        <div key={idx} className="p-4 rounded-lg bg-gray-5 dark:bg-gray-8 border border-gray-1 dark:border-gray-7">
                          ...
                          <div className="flex flex-wrap items-center gap-3 mt-3">
                            ...
                            {member.profileUrl && (
                              <Button asChild variant="ghost" size="sm" className="h-6 text-[10px] font-bold text-blue-7 hover:bg-blue-5 p-0 hover:px-2 transition-all">
              ...
              {boardMembers.length > 0 ? (
                ...
                <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
                  ...
                  <CardContent className="pt-1 pb-1 text-center">
                    <Users className="h-2 w-2 text-blue-4 mx-auto mb-6" />
                    <h3 className="text-2xl font-semibold mb-3 text-blue-9 dark:text-blue-3">Join Our Editorial Board</h3>
                    <p className="text-base text-blue-6 dark:text-blue-4 max-w-md mx-auto mb-8">
                    ...
                    <Button 
                      ...
                      className="bg-blue-9 hover:bg-blue-8 text-white"
                      size="lg"
                    >
            ...
            <Card className="bg-white dark:bg-gray-9 overflow-hidden">
              <CardHeader className="bg-[#213361] border-0 py-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    <div className="h-1 w-1 rounded-full bg-white/2 flex items-center justify-center">
                      <Calendar className="h-6 w-6 text-yellow-4" />
                    </div>
                    <div>
                      <CardTitle className="text-xl md:text-2xl font-serif text-white">
                        Current Issue (January - March 2026)
                      </CardTitle>
                      <p className="text-sm md:text-base font-medium text-blue-1">
                  ...
                  {currentVolume !== "1" && (
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      className="text-white hover:bg-white/1 transition-colors"
                      onClick={() => {
                        setActiveTab("archives");
                        setSelectedVolume("v");
                        setSelectedIssue("i");
                        window.location.hash = "archives/v1/i";
                      }}
                    >
                ...
                {articles && articles.length > 0 ? (
                  <div className="space-y-4">
                    {articles.map((article) => (
                      <Card key={article.id} className="border-l-4 border-[#213361] shadow-md hover:shadow-lg transition-all bg-white dark:bg-gray-9 overflow-hidden mb-6">
                        <CardContent className="p-4 md:p-5">
                          <div className="flex flex-col md:flex-row gap-4 md:gap-5">
                            <div className="flex-shrink-0 hidden md:flex">
                              <div className="h-1 w-1 rounded-lg bg-blue-5 dark:bg-blue-900/3 flex items-center justify-center border border-blue-1 dark:border-blue-8">
                                <span className="text-base font-bold text-[#213361] dark:text-blue-3">{article.id}</span>
                              </div>
                            </div>
                            <div className="flex-1 space-y-3">
                              <div className="space-y-1.5">
                                <div className="flex items-center gap-2 md:hidden mb-1">
                                  <span className="px-2 py-0.5 bg-blue-5 dark:bg-blue-900/3 text-[#213361] dark:text-blue-3 text-[10px] font-bold rounded">Article {article.id}</span>
                                </div>
                                ...
                                {article.affiliation && (
                                  <div className="flex items-start gap-2 text-gray-5 dark:text-gray-5 italic text-xs">
                                    <BookOpen className="h-3.5 w-3.5 mr-2 text-blue-4 shrink-0 mt-0.5" />
                                    <span>{article.affiliation}</span>
                                  </div>
                                )}
                              </div>

                              <div className="flex flex-wrap items-center gap-x-6 gap-y-4 pt-3 border-t border-gray-5 dark:border-gray-8">
                                <div className="flex items-center gap-2">
                                  <FileText className="h-3.5 w-3.5 text-blue-6 dark:text-blue-4 shrink-0" />
                                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-4 mr-1">Pages</span>
                                  <span className="text-xs font-semibold text-gray-9 dark:text-gray-1">{article.pages}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <ExternalLink className="h-3.5 w-3.5 text-blue-6 dark:text-blue-4 shrink-0" />
                                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-4 mr-1">DOI</span>
                                  {article.doi ? (
                                    <a href={`https://doi.org/${article.doi}`} target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-blue-6 dark:text-blue-4 hover:underline break-all">{article.doi}</a>
                                  ) : (
                                    <span className="text-xs font-semibold text-gray-5 italic">In progress</span>
                                  )}
                                </div>
                                <div className="flex items-center gap-3 ml-auto">
                                  <Button asChild variant="ghost" className="h-8 text-xs font-bold text-blue-7 hover:text-blue-8 hover:bg-blue-5 px-3 border border-transparent hover:border-blue-1">
                                    <Link href={`/article/${article.articleId}`}>
                                      <Search className="h-3.5 w-3.5 mr-2" /> Abstract
                                    </Link>
                                  </Button>
                                  <Button asChild variant="ghost" className="h-8 text-xs font-bold text-blue-9 hover:text-blue-8 hover:bg-blue-5 px-3 border border-transparent hover:border-blue-1">
                  ...
                  <div className="pt-1 pb-1 text-center">
                    <Calendar className="h-2 w-2 text-blue-4 mx-auto mb-6" />
                    <h3 className="text-2xl font-semibold mb-3 text-blue-9 dark:text-blue-3">Coming Soon</h3>
                    <p className="text-base text-blue-6 dark:text-blue-4 max-w-md mx-auto">
            ...
            <div className="space-y-0">
              {(() => {
                ...
                const volumes = isCommerce
                  ? [
                      { key: "v", label: "Volume 2 (Current)", period: "Jan - Dec 2", status: "In Progress", issues: [
                        { num: 1, label: "Issue 1", period: "Jan - Mar 2", hasArticles: true, getArticles: () => articles },
                        { num: 2, label: "Issue 2", period: "Apr - Jun 2", hasArticles: false, getArticles: () => [] as Article[] },
                        { num: 3, label: "Issue 3", period: "Jul - Sep 2", hasArticles: false, getArticles: () => [] as Article[] },
                        { num: 4, label: "Issue 4", period: "Oct - Dec 2", hasArticles: false, getArticles: () => [] as Article[] },
                      ]},
                      { key: "v", label: "Volume 1", period: "Oct - Dec 2", status: "Published", issues: [
                        { num: 1, label: "Issue 1", period: "Oct - Dec 2", hasArticles: true, getArticles: () => archivedArticles },
                      ]},
                    ]
                  : [
                      { key: "v", label: "Volume 1 (Current)", period: "Jan - Dec 2", status: "In Progress", issues: [
                        { num: 1, label: "Issue 1", period: "Jan - Mar 2", hasArticles: true, getArticles: () => articles },
                        { num: 2, label: "Issue 2", period: "Apr - Jun 2", hasArticles: false, getArticles: () => [] as Article[] },
                        { num: 3, label: "Issue 3", period: "Jul - Sep 2", hasArticles: false, getArticles: () => [] as Article[] },
                        { num: 4, label: "Issue 4", period: "Oct - Dec 2", hasArticles: false, getArticles: () => [] as Article[] },
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        {volumes.map((vol) => (
                          <div
                            key={vol.key}
                            className="bg-white dark:bg-gray-9 rounded-xl border border-gray-2 dark:border-gray-7 p-6 cursor-pointer hover-elevate transition-all"
                            onClick={() => {
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                <div className="h-1 w-1 rounded-xl bg-blue-5 dark:bg-blue-900/3 flex items-center justify-center border border-blue-1 dark:border-blue-8">
                                  <Archive className="h-7 w-7 text-[#213361] dark:text-blue-3" />
                                </div>
                                <div>
                                  <h3 className="text-xl font-serif font-bold text-[#213361] dark:text-blue-3">{vol.label}</h3>
                                  <div className="flex items-center gap-2 mt-1">
                                    <Calendar className="h-3.5 w-3.5 text-blue-6 dark:text-blue-4" />
                                    <span className="text-sm font-semibold text-blue-8 dark:text-blue-4">{vol.period}</span>
                                  </div>
                                  <div className={`mt-2 inline-flex items-center px-2.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider border ${vol.status === "In Progress" ? "bg-green-1 text-green-8 dark:bg-green-900/3 dark:text-green-4 border-green-2 dark:border-green-8" : "bg-blue-1 text-blue-8 dark:bg-blue-900/3 dark:text-blue-4 border-blue-2 dark:border-blue-8"}`}>
                                    {vol.status}
                                  </div>
                                </div>
                              </div>
                              <ChevronRight className="h-6 w-6 text-blue-4" />
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  return (
                    <div className="space-y-6">
                      <div className="bg-[#213361] rounded-xl p-6 text-white">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <button onClick={handleBack} className="p-1.5 rounded-lg hover:bg-white/1 transition-colors" data-testid="button-back-volumes">
                      ...
                      <div className={`grid grid-cols-1 ${currentVol.issues.length > 1 ? "md:grid-cols-2" : ""} gap-4`}>
                        {currentVol.issues.map((issue) => (
                          <div
                            key={issue.num}
                            className="bg-white dark:bg-gray-9 rounded-xl border border-gray-2 dark:border-gray-7 p-5 transition-all cursor-pointer hover-elevate"
                            onClick={() => {
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                <div className="h-1 w-1 rounded-lg bg-blue-5 dark:bg-blue-900/3 flex items-center justify-center border border-blue-1 dark:border-blue-8">
                                  <FileText className="h-5 w-5 text-[#213361] dark:text-blue-3" />
                                </div>
                                <div>
                                  <h3 className="text-lg font-serif font-bold text-[#213361] dark:text-blue-3">{issue.label}</h3>
                                  <p className="text-sm text-gray-5 dark:text-gray-4">{issue.period}</p>
                                  {!issue.hasArticles && (
                                    <p className="text-xs text-gray-4 dark:text-gray-5 italic mt-1">Upcoming</p>
                                  )}
                                </div>
                              </div>
                              <ChevronRight className="h-5 w-5 text-blue-4" />
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  return (
                    <div className="space-y-6">
                      <div className="bg-[#213361] rounded-xl p-6 text-white">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <button onClick={handleBack} className="p-1.5 rounded-lg hover:bg-white/1 transition-colors" data-testid="button-back-issues">
                              <ArrowLeft className="h-5 w-5 text-white" />
                            </button>
                            <div>
                          ...
                          {issueArticles.length > 0 && (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-white/1 text-white border border-white/2">
                      ...
                      {issueArticles.length > 0 ? (
                        ...
                        <div className="bg-white dark:bg-gray-9 rounded-xl border-2 border-dashed border-gray-3 dark:border-gray-7 p-1 text-center">
                          <Calendar className="h-1 w-1 text-blue-3 dark:text-blue-7 mx-auto mb-4" />
                          <h3 className="text-xl font-serif font-bold text-[#213361] dark:text-blue-3 mb-2">No articles published in this issue yet</h3>
              ...
              <CardContent className="pt-6">
                {!showReviewerForm ? (
                  <div className="space-y-1">
                    ...
                    <div className="bg-[#213361]/5 dark:bg-[#213361]/2 p-8 rounded-lg border border-[#213361]/2 text-center">
                      <h3 className="text-2xl font-serif font-bold text-[#213361] dark:text-blue-3 mb-2">Become a Reviewer / Editor</h3>
                      <p className="text-[#213361] dark:text-blue-4 font-bold mb-4">Join our distinguished panel of expert reviewers</p>
                      <p className="text-gray-7 dark:text-gray-3 mb-6 max-w-2xl mx-auto text-lg italic">
                        "Share your expertise and contribute to advancing scholarly research"
                      </p>
                      <Button 
                        onClick={() => setShowReviewerForm(true)} 
                        className="bg-[#213361] hover:bg-[#2a4078] text-white px-1 h-1 text-lg font-bold"
                      >
                        Apply Now
                      </Button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Card className="border-blue-1 dark:border-blue-9 hover-elevate cursor-pointer overflow-hidden group">
                        <Link href="/reviewer-login">
                          <CardContent className="p-0">
                            ...
                            <div className="p-4">
                              <p className="text-sm text-gray-6 dark:text-gray-4">Access your dashboard, assigned manuscripts, and submit reviews.</p>
                              <div className="mt-4 flex items-center text-blue-9 dark:text-blue-3 text-sm font-bold uppercase tracking-wider">
                      ...
                      <Card className="border-blue-1 dark:border-blue-9 hover-elevate cursor-pointer overflow-hidden group">
                        <Link href="/reviewer-search">
                          <CardContent className="p-0">
                            ...
                            <div className="p-4">
                              <p className="text-sm text-gray-6 dark:text-gray-4">View your reviewer/editor profile and application status.</p>
                              <div className="mt-4 flex items-center text-blue-7 dark:text-blue-3 text-sm font-bold uppercase tracking-wider">
                        ...
                        <div className="grid gap-6">
                          <div className="flex gap-4 items-start">
                            <div className="h-8 w-8 rounded-full bg-green-5 dark:bg-green-900/2 flex items-center justify-center shrink-0">
                              <CheckCircle className="h-5 w-5 text-green-6" />
                            </div>
                            <div>
                              <p className="font-bold text-gray-9 dark:text-white">Certificate of Appreciation</p>
                              <p className="text-sm text-gray-6 dark:text-gray-4">Official certificate for every review you complete</p>
                            </div>
                          </div>
                          <div className="flex gap-4 items-start">
                            <div className="h-8 w-8 rounded-full bg-green-5 dark:bg-green-900/2 flex items-center justify-center shrink-0">
                            ...
                            <div>
                              <p className="font-bold text-gray-9 dark:text-white">Professional Recognition</p>
                              <p className="text-sm text-gray-6 dark:text-gray-4">Enhance your academic profile and reputation</p>
                            </div>
                          </div>
                          <div className="flex gap-4 items-start">
                            <div className="h-8 w-8 rounded-full bg-green-5 dark:bg-green-900/2 flex items-center justify-center shrink-0">
                            ...
                            <div>
                              <p className="font-bold text-gray-9 dark:text-white">Early Access to Research</p>
                              <p className="text-sm text-gray-6 dark:text-gray-4">Review cutting-edge research before publication</p>
                            </div>
                          </div>
                          <div className="flex gap-4 items-start">
                            <div className="h-8 w-8 rounded-full bg-green-5 dark:bg-green-900/2 flex items-center justify-center shrink-0">
                            ...
                            <div>
                              <p className="font-bold text-gray-9 dark:text-white">Networking & Skills Development</p>
                              <p className="text-sm text-gray-6 dark:text-gray-4">Connect globally and sharpen analytical abilities</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex gap-3 items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7">
                          ...
                          <span className="text-gray-7 dark:text-gray-3">Provide constructive, timely feedback</span>
                        </div>
                        <div className="flex gap-3 items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7">
                          <ShieldCheck className="h-5 w-5 text-blue-6 shrink-0" />
                          <span className="text-gray-7 dark:text-gray-3">Maintain confidentiality of materials</span>
                        </div>
                        <div className="flex gap-3 items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7">
                          <Award className="h-5 w-5 text-blue-6 shrink-0" />
                          <span className="text-gray-7 dark:text-gray-3">Follow ethical peer review guidelines</span>
                        </div>
                        <div className="flex gap-3 items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7">
                          <Users className="h-5 w-5 text-blue-6 shrink-0" />
                          <span className="text-gray-7 dark:text-gray-3">Declare any conflicts of interest</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-5 dark:bg-gray-800/5 p-8 rounded-xl border border-gray-1 dark:border-gray-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-1">
                        {[
                          ...
                          { step: 3, title: "Double-Blind Peer Review (15-2 days)", desc: "Assigned to 2-3 expert peer reviewers for objective and anonymous assessment." },
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="text-center p-6 bg-white dark:bg-gray-9 rounded-lg shadow-sm border border-blue-5 dark:border-gray-8">
                          <p className="text-2xl md:text-3xl font-bold text-blue-9 dark:text-blue-3">15-20</p>
                          <p className="text-[10px] md:text-xs text-gray-5 uppercase tracking-widest mt-1">Days Peer Review</p>
                        </div>
                        <div className="text-center p-6 bg-white dark:bg-gray-9 rounded-lg shadow-sm border border-blue-5 dark:border-gray-8">
                          <p className="text-2xl md:text-3xl font-bold text-blue-9 dark:text-blue-3">2-3</p>
                          <p className="text-[10px] md:text-xs text-gray-5 uppercase tracking-widest mt-1">Expert Reviewers</p>
                        </div>
                        <div className="text-center p-6 bg-white dark:bg-gray-9 rounded-lg shadow-sm border border-blue-5 dark:border-gray-8">
                          <p className="text-2xl md:text-3xl font-bold text-blue-9 dark:text-blue-3">Double</p>
                          <p className="text-[10px] md:text-xs text-gray-5 uppercase tracking-widest mt-1">Blind Review</p>
                        </div>
                        <div className="text-center p-6 bg-white dark:bg-gray-9 rounded-lg shadow-sm border border-blue-5 dark:border-gray-8">
                          <p className="text-2xl md:text-3xl font-bold text-blue-9 dark:text-blue-3">~30</p>
                          <p className="text-[10px] md:text-xs text-gray-5 uppercase tracking-widest mt-1">Days Total Process</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    <Button variant="outline" onClick={() => setShowReviewerForm(false)} className="mb-6 border-blue-9 text-blue-9">
              ...
              <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
                <CardHeader className="bg-[#213361] border-0">
                  <CardTitle className="text-2xl font-serif flex items-center text-white">
                    <Edit className="h-6 w-6 mr-2 text-yellow-4" /> Author Guidelines
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-8 pt-6">
                  {/* General Policies */}
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">General Policies</h3>
                    <div className="space-y-4 text-gray-7 dark:text-gray-3 leading-relaxed">
                  ...
                  {/* AI Policy */}
                  <div className="space-y-4 bg-blue-50/5 dark:bg-blue-950/2 p-6 rounded-lg border border-blue-1 dark:border-blue-9">
                    <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">AI & LLM Policy</h3>
                    <ul className="space-y-3 text-gray-7 dark:text-gray-3">
                  ...
                  {/* Publication Ethics */}
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">Publication Ethics & Integrity</h3>
                    <div className="space-y-4 text-gray-7 dark:text-gray-3">
                  ...
                  {/* Article Structure */}
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">Manuscript Structure</h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <ul className="space-y-2 text-gray-7 dark:text-gray-3">
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Title & Short Title</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Author Names & Email Addresses</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Abstract (Max 2 words)</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Keywords (Up to 6)</li>
                      </ul>
                      <ul className="space-y-2 text-gray-7 dark:text-gray-3">
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Introduction</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Methods</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Results & Discussion</li>
                        <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-blue-6"></div>Conclusions & References</li>
                      </ul>
                    </div>
                  </div>

                  {/* Reference Style */}
                  <div className="space-y-4 p-6 border border-gray-1 dark:border-gray-8 rounded-lg">
                    {referenceStyle === "APA_MLA" ? (
                      <>
                        <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">Reference Style (APA & MLA)</h3>
                        <div className="space-y-8">
                          {/* APA Section */}
                          <div className="space-y-4">
                            ...
                            <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                              <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Journal Article</p>
                              Grady, J. S., Her, M., Moreno, G., Perez, C., & Yelinek, J. (2019). Emotions in storybooks. Psychology of Popular Media Culture, 8(3), 207–217.
                            </div>
                            <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                              <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Conference Paper</p>
                              Author, A. A. (Year, Month). Title of the paper. Paper presented at Conference Name, Location.
                            </div>
                            <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                              <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Book / Book Chapter</p>
                              Author, A. A. (Year). Title of the book. Publisher.
                            </div>
                            <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                              <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Thesis</p>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-4">
                              <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                                <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Journal Article</p>
                                Author, First Name, and Second Author. "Article Title." Journal Title, vol. 2, no. 2, 2, pp. 121-127.
                              </div>
                              <div className="p-3 bg-gray-5 dark:bg-gray-8 rounded font-mono text-xs md:text-sm">
                                <p className="text-blue-6 dark:text-blue-4 mb-1 font-bold">// Conference Paper</p>
                      ...
                      <>
                        <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">Reference Style (APA)</h3>
                        <div className="space-y-6">
                          <div className="space-y-2">
                            <p className="font-bold text-gray-9 dark:text-white">Citations in Text:</p>
                            <ul className="list-disc list-inside space-y-1 text-sm text-gray-7 dark:text-gray-3">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold text-blue-9 dark:text-blue-3">Correction, Retraction & Removal</h3>
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        <p className="font-bold text-sm">Correction</p>
                        <p className="text-xs text-gray-6 dark:text-gray-4">Published if the scholarly record is seriously affected (accuracy, meaning, reproducibility).</p>
                      </div>
                      <div className="space-y-2">
                        <p className="font-bold text-sm">Retraction</p>
                        <p className="text-xs text-gray-6 dark:text-gray-4">Reserved for cases where conclusions are undermined or ethical codes are breached.</p>
                      </div>
                      <div className="space-y-2">
                        <p className="font-bold text-sm">Removal</p>
                        <p className="text-xs text-gray-6 dark:text-gray-4">Only in extreme cases (defamatory content, legal infringement, or court orders).</p>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-white dark:bg-gray-9 border-gray-2 dark:border-gray-7 overflow-hidden">
              ...
              <CardContent className="pt-8">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                  <div className="flex flex-col items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7 hover-elevate transition-all">
                    <Database className="h-1 w-1 text-blue-6 mb-2" />
                    <span className="text-sm font-bold text-blue-9 dark:text-blue-3">Crossref</span>
                    <span className="text-[10px] text-gray-5 uppercase tracking-wider">DOI Partner</span>
                  </div>
                  <div className="flex flex-col items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7 hover-elevate transition-all">
                    <Users className="h-1 w-1 text-blue-6 mb-2" />
                    <span className="text-sm font-bold text-blue-9 dark:text-blue-3">ResearchGate</span>
                    <span className="text-[10px] text-gray-5 uppercase tracking-wider">Academic Network</span>
                  </div>
                  <div className="flex flex-col items-center p-4 bg-gray-5 dark:bg-gray-8 rounded-lg border border-gray-1 dark:border-gray-7 hover-elevate transition-all">
                    <BookOpen className="h-1 w-1 text-blue-6 mb-2" />
                    <span className="text-sm font-bold text-blue-9 dark:text-blue-3">Academia.edu</span>
                    <span className="text-[10px] text-gray-5 uppercase tracking-wider">Repository</span>
                  </div>
                </div>
              </CardContent>
            </Card>
