...
const articles: Record<string, Article> = {
  ...
  "sjcm-v2i1-002": {
    ...
    keywords: ["Creativity", "Curiosity", "Higher Secondary Students", "Cognitive Development"],
  ...
  "sjhss-v1i1-004": {
    ...
    abstract: "Caregivers of children diagnosed with Attention-Deficit/Hyperactivity Disorder (ADHD) frequently experience high levels of psychological burden and reduced resilience due to persistent caregiving responsibilities. The present study examined the effectiveness of laughter therapy as a non-pharmacological intervention for reducing caregiver burden and enhancing resilience. A quasi-experimental pre-test and post-test design was employed with a purposive sample of 30 primary caregivers of children with ADHD. Standardized measures of caregiver burden and resilience were administered before and after a structured laughter therapy program. Paired sample t-test results revealed a statistically significant reduction in caregiver burden and a significant improvement in resilience following the intervention. The findings indicate that laughter therapy serves as an effective, low-cost psychological intervention for promoting caregiver well-being. The study highlights the importance of incorporating caregiver-focused emotional interventions into clinical and community support programs.",
    keywords: ["Laughter Therapy", "Caregiver Burden", "Resilience", "ADHD Caregivers"],
  ...
  "sjcm-v2i1-008": {
    ...
    keywords: ["Digital Marketing", "Small Business Development", "Online Consumer Behavior"],
  ...
  "sjhss-v1i2-001": {
    ...
    year: "2026",
    journal: "Scholar Journal of Humanities and Social Sciences",
    pdfUrl: "/downloads/SIPHSv1i201.pdf",
    abstract: "The Concept of Poverty existing in all forms in Urban and Rural Poor Habitats in India, the ratio of urban poverty is higher than the rural poverty due to the Criminogenic Risk Factors and the Environment they live in. As rural people migrate to urban for various reasons, the Global Hunger Index (GHI) listed India in 105th Rank out of 127 countries. The pandemic situation leads to health issues and various other issues like Hunger, Poverty, Migration, and Crimes in Urban Poor Habitat. There was a continuous Case of Violence, Theft, Suicide, and Abuse and so on. The need of the Criminal Justice becomes the necessity of the hour for the urban poor. Based on the previous studies reviewed, there is an association between Urban Poverty and Crime Activities. The methodology of the study was qualitative analysis based on literature and conceptual analysis, comprised of the Concept of Urban Poverty and Criminal Justice, and its relation to Socio – Economic, Political and cultural conditions and its various theories and models, Constitutional Remedies and Indian Legislations, Rights Based Social Justice of the Urban Poor Habitats and the Role of Social Workers in Advocating and Lobbying the issues of Urban Poor in relation to Criminal Justice. Based on the intense reviews and thematic analysis the theory was developed on the 'Cycle of Poverty Culture' was proposed to understand the crime activities in the Urban Poor Habitat and why Criminal Justice need to be coarticulated at Macro level interventions are needed through Social Policy and Legislation for the betterment of the Urban Poor Habitat.",
    keywords: ["Urban Poverty", "Criminal Justice", "Social Work"],
  ...
  "sjhss-v1i2-002": {
    ...
    year: "2026",
    journal: "Scholar Journal of Humanities and Social Sciences",
    pdfUrl: "/downloads/SIPHSv1i202.pdf",
    abstract: "Infosys Limited, a global leader in digital services and consulting, has consistently advanced community development through its Corporate Social Responsibility (CSR) initiatives. The company's approach to resilience and capacity building is rooted in the belief that sustainable growth requires empowered communities capable of adapting to social, economic, and environmental challenges. Through the Infosys Foundation, the organization has invested in healthcare infrastructure, digital education platforms, women's empowerment programs, and environmental sustainability projects. Healthcare initiatives have focused on expanding access to specialized services, supporting hospitals, and promoting mental health awareness. Women's empowerment projects have provided vocational training, microfinance opportunities, and mentorship, fostering economic independence and social equity. Environmental efforts, including afforestation and renewable energy adoption, contribute to climate resilience and community awareness of ecological stewardship. By aligning its CSR strategy with the United Nations Sustainable Development Goals (SDGs), Infosys demonstrates how corporate responsibility can serve as a catalyst for resilience and capacity building. The company's initiatives illustrate a replicable model for integrating business success with social impact, highlighting the transformative potential of private sector engagement in sustainable development.",
    keywords: ["Community Resilience", "Capacity Building", "Corporate Social Responsibility"],
    ...
    async function loadArticle() {
      ...
      try {
        ...
        setArticle({
          ...
          pdfUrl: artData.pdf_url || `/downloads/${artData.article_id}.pdf`,
          doi: artData.doi || undefined,
          abstract: artData.abstract,
          keywords: typeof artData.keywords === 'string' ? artData.keywords.split(',').map((k: string) => k.trim()) : (artData.keywords || [])
        });
      } catch (err) {
      ...
      <div className="min-h-screen bg-white flex items-center justify-center flex-col gap-4">
        <Card className="max-w-md">
          <CardContent className="text-center py-12">
            ...
            <Button asChild className="bg-[#213361]">
                    ...
                    <div className="space-y-2 pt-1">
                      ...
                      <div className="pt-3 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          ...
                          {article.doi ? (
                            <a href={`https://doi.org/${article.doi}`} target="_blank" rel="noopener noreferrer" className="text-[#213361] dark:text-blue-400 hover:underline font-medium">
                              {article.doi}
                            </a>
                          ) : <span className="text-gray-400 italic">(will be added later)</span>}
                        </p>
                        <Button
                          size="sm"
                    ...
                    <div className="space-y-3">
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div className="flex items-center gap-2 px-4 py-2 bg-[#213361] text-white">
                          <span className="text-xs font-bold uppercase tracking-wider">APA (7th Edition)</span>
                        </div>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div className="flex items-center gap-2 px-4 py-2 bg-[#213361] text-white">
                          <span className="text-xs font-bold uppercase tracking-wider">Harvard</span>
                        </div>
                        <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed px-4 py-3 font-mono">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div className="flex items-center gap-2 px-4 py-2 bg-[#213361] text-white">
                          <span className="text-xs font-bold uppercase tracking-wider">MLA (9th Edition)</span>
                        </div>
                        <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed px-4 py-3 font-mono">
                          {generateMLACitation()}
                        </p>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div className="flex items-center gap-2 px-4 py-2 bg-[#213361] text-white">
                          <span className="text-xs font-bold uppercase tracking-wider">Chicago</span>
                        </div>
                        <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed px-4 py-3 font-mono">
            ...
            <div className="lg:col-span-1">
              <div className="space-y-4 sticky top-28">
                <Card className="border border-gray-200 dark:border-gray-700 overflow-hidden">
                  ...
                  <CardContent className="px-4 py-3 space-y-3 text-xs">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">Vol. {article.volume}, No. {article.issue}</p>
                    </div>
                    <div>
                ...
                <Card className="border border-gray-200 dark:border-gray-700 overflow-hidden">
                  ...
                  <CardContent className="px-4 py-3">
                    <Button className="w-full bg-[#213361] hover:bg-[#2a4078] text-white font-semibold text-sm" asChild>
