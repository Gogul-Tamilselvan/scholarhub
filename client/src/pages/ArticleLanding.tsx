...
const articles: Record<string, Article> = {
  "sjcm-v1i1-0": {
    ...
    keywords: ["M-Commerce", "Developing Economies", "Government Initiatives", "Digital Infrastructure", "Financial Inclusion", "Mobile Payments", "E-Governance", "Public–Private Partnerships", "Digital Literacy", "Economic Growth", "Digital Transformation"],
    doi: "10.65219/sjcm.2"
  },
  "sjcm-v1i1-0": {
    id: "sjcm-v1i1-0",
  ...
  "sjcm-v1i1-0": {
    ...
    keywords: ["Social Media Advertising", "Consumer Behaviour", "Brand Awareness", "Trust", "Loyalty", "Purchasing Intent", "Digital Marketing", "Online Engagement", "Personalized Advertising"],
    doi: "10.65219/sjcm.2"
  },
  "sjcm-v2i1-0": {
    id: "sjcm-v2i1-0",
  ...
  "sjcm-v2i1-0": {
    ...
    keywords: ["Creativity", "Curiosity", "Higher Secondary Students", "Cognitive Development", "Tiruvallur District"],
    doi: "10.65219/sjcm.2"
  },
  "sjhss-v1i1-0": {
    id: "sjhss-v1i1-0",
    ...
    authors: "Ganesan V",
    affiliation: "Centre of Online and Distance Education (CDOE), Bharathidasan University, Tiruchirappalli, India",
    pages: "0 - 0",
    volume: "1",
    issue: "1",
    year: "2",
  ...
  "sjhss-v1i1-0": {
    ...
    keywords: ["Masculinity", "Fatherhood", "Emotional Vulnerability", "Ethical Responsibility", "The Child in Time", "The Kite Runner"],
    doi: "10.65219/sjhss.2"
  },
  "sjhss-v1i1-0": {
    id: "sjhss-v1i1-0",
    ...
    affiliation: "Ph.D. Research Scholar, School of Liberal Arts and Humanities, Woxsen University, Hyderabad, India; Assistant Professor of English, Government Arts and Science College, Idappadi, India",
    pages: "1 – 1",
    volume: "1",
    issue: "1",
    year: "2",
    ...
    keywords: ["Diaspora", "Exile", "Motherhood", "Maternal Care", "Partition", "South Asian Literature", "Ethical Resistance"],
    doi: "10.65219/sjhss.2"
  },
  "sjhss-v1i1-0": {
    id: "sjhss-v1i1-0",
    ...
    affiliation: "Ph.D. Research Scholar, Department of Psychology, Annamalai University; Associate Professor, Department of Psychology, Annamalai University, Annamalai Nagar, Cuddalore",
    pages: "1 – 2",
    volume: "1",
    issue: "1",
    year: "2",
    ...
    abstract: "Caregivers of children diagnosed with Attention-Deficit/Hyperactivity Disorder (ADHD) frequently experience high levels of psychological burden and reduced resilience due to persistent caregiving responsibilities. The present study examined the effectiveness of laughter therapy as a non-pharmacological intervention for reducing caregiver burden and enhancing resilience. A quasi-experimental pre-test and post-test design was employed with a purposive sample of 3 primary caregivers of children with ADHD. Standardized measures of caregiver burden and resilience were administered before and after a structured laughter therapy program. Paired sample t-test results revealed a statistically significant reduction in caregiver burden and a significant improvement in resilience following the intervention. The findings indicate that laughter therapy serves as an effective, low-cost psychological intervention for promoting caregiver well-being. The study highlights the importance of incorporating caregiver-focused emotional interventions into clinical and community support programs.",
  ...
  "sjhss-v1i1-0": {
    ...
    authors: "Devi K, Ariharan S, Dr. P. Rajini",
    affiliation: "B.Ed. Student, Avinashilingam Institute for Home Science & Higher Education for Women, Coimbatore, India; Ph.D. Research Scholar, School of Liberal Arts and Humanities, Woxsen University, Hyderabad, India; Assistant Professor of English, Government Arts and Science College, Idappadi, India",
    pages: "2 – 3",
    volume: "1",
    issue: "1",
    year: "2",
  ...
  "sjhss-v1i1-0": {
    ...
    affiliation: "Assistant Professor of English, Kailash Women’s College, Nangavalli, India; Ph.D. Research Scholar, School of Liberal Arts and Humanities, Woxsen University, Hyderabad, India",
    pages: "3 – 4",
    volume: "1",
    issue: "1",
    year: "2",
    ...
    keywords: ["Cyborg Subjectivities", "Postgender Futures", "Donna Haraway", "Rosi Braidotti", "Posthuman Feminism", "New Materialism"],
    doi: "10.65219/sjhss.2"
  },
  "sjcm-v2i1-0": {
    id: "sjcm-v2i1-0",
  ...
  "sjhss-v1i1-0": {
    ...
    affiliation: "M.Sc. Applied Psychology, Department of Psychology, Annamalai University; Ph.D. Research Scholar, Department of Psychology, Annamalai University; Associate Professor, Department of Psychology, Annamalai University, Annamalai Nagar, Cuddalore",
    pages: "4 – 5",
    volume: "1",
    issue: "1",
    year: "2",
    ...
    keywords: ["Doomscrolling", "Emotional Regulation", "Psychological Distress", "Working Employees"],
    doi: "10.65219/sjhss.2"
  },
  "sjhss-v1i1-0": {
    id: "sjhss-v1i1-0",
...
export default function ArticleLanding() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="text-center py-1">
            <FileText className="h-1 w-1 text-muted-foreground mx-auto mb-4" />
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen bg-white dark:bg-gray-9">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8">
          <Button 
          variant="ghost" 
          className="mb-6 text-blue-6 hover:text-blue-9 dark:text-blue-4" 
        ...
        >
          ...
          <CardHeader className="bg-[#213361] border-0">
            <div className="space-y-4">
              <div className="text-sm text-yellow-4 font-medium">
                {article.journal}
              </div>
              ...
              <div className="space-y-2 text-sm">
                <p className="text-base font-medium text-blue-1">
                  {article.authors}
                </p>
                <p className="text-sm italic text-blue-2">
                  {article.affiliation}
                </p>
                <div className="pt-2 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  <p className="text-sm text-blue-1">
                    <span className="font-medium text-yellow-4">DOI:</span>{" "}
                    {article.doi ? (
                      <a
                        href={`https://doi.org/${article.doi}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-2 hover:text-white hover:underline"
                      >
                        {article.doi}
                      </a>
                    ) : (
                      <span className="text-blue-3 italic">
                        (will be added later)
                      </span>
                    )}
                  </p>
                  <Button
                    size="sm"
                    className="bg-yellow-5 hover:bg-yellow-4 text-blue-9 font-semibold shadow-md hover:shadow-lg transition-all w-full md:w-auto"
                    onClick={() => {
          ...
          <CardContent className="mt-6 space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-blue-5 dark:bg-blue-9 rounded-md border border-blue-2 dark:border-blue-9">
              <div>
                <p className="text-xs text-blue-6 dark:text-blue-4 font-medium mb-1">Volume</p>
                <p className="text-sm font-semibold text-gray-9 dark:text-gray-1">{article.volume}</p>
              </div>
              <div>
                <p className="text-xs text-blue-6 dark:text-blue-4 font-medium mb-1">Issue</p>
                <p className="text-sm font-semibold text-gray-9 dark:text-gray-1">{article.issue}</p>
              </div>
              <div>
                <p className="text-xs text-blue-6 dark:text-blue-4 font-medium mb-1">Pages</p>
                <p className="text-sm font-semibold text-gray-9 dark:text-gray-1">{article.pages}</p>
              </div>
              <div>
                <p className="text-xs text-blue-6 dark:text-blue-4 font-medium mb-1">Year</p>
                <p className="text-sm font-semibold text-gray-9 dark:text-gray-1">{article.year}</p>
              </div>
            </div>

            {article.abstract && (
              <div>
                <h3 className="text-lg font-serif font-bold mb-3 text-blue-9 dark:text-blue-3">Abstract</h3>
                <p className="text-sm text-gray-7 dark:text-gray-3 leading-relaxed">
                  {article.abstract}
                </p>
              </div>
            )}
            ...
            {article.keywords && article.keywords.length > 0 && (
              <div>
                <h3 className="text-lg font-serif font-bold mb-3 text-blue-9 dark:text-blue-3">Keywords</h3>
                <div className="flex flex-wrap gap-2">
                  {article.keywords.map((keyword, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-blue-1 dark:bg-blue-9 text-blue-9 dark:text-blue-3 text-xs rounded-full font-medium"
                    >
                      {keyword}
                    </span>
                  ))}
            ...
            <div className="border-t border-gray-2 dark:border-gray-7 pt-6">
              <h3 className="text-lg font-serif font-bold mb-3 text-blue-9 dark:text-blue-3">How to Cite</h3>
              <div className="bg-blue-5 dark:bg-blue-9 p-4 rounded-md border border-blue-2 dark:border-blue-9">
                <p className="text-sm font-semibold text-blue-6 dark:text-blue-4 mb-2">APA Citation:</p>
                <p className="text-sm text-gray-9 dark:text-gray-1 leading-relaxed italic">
                  {generateAPACitation()}
                </p>
              </div>
            </div>
