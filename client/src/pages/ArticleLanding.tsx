...
const articles: Record<string, Article> = {
  ...
  "sjhss-v1i1-004": {
    ...
    authors: "R. Salman*1, S.Srikumaran1, K. Nagalakshmi2",
  ...
  "sjhss-v1i1-005": {
    ...
    authors: "Devi K*1, Ariharan S2, Dr. P. Rajini3",
  ...
  "sjhss-v1i1-006": {
    ...
    authors: "Karthika G*1, Ariharan S2",
  ...
  "sjhss-v1i1-007": {
    ...
    authors: "S. Srikumaran*1, K. Nagalakshmi2",
    affiliation: "Ph.D. Research Scholar, Department of Psychology, Annamalai University; Associate Professor, Department of Psychology, Annamalai University, Annamalai Nagar, Cuddalore",
    pages: "42 – 47",
    volume: "1",
    issue: "1",
  ...
  "sjhss-v1i1-008": {
    ...
    authors: "S. Vasanth*1, S. Srikumaran2, K. Nagalakshmi3",
        ...
        >
          ...
          <CardContent className="mt-6 space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-blue-50 dark:bg-blue-950 rounded-md border border-blue-200 dark:border-blue-900">
              <div>
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Volume</p>
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{article.volume}</p>
              </div>
              <div>
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Issue</p>
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{article.issue}</p>
              </div>
              <div>
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Pages</p>
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{article.pages}</p>
              </div>
              <div>
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Year</p>
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{article.year}</p>
              </div>
            </div>

            {article.abstract && (
              <div>
                <h3 className="text-lg font-serif font-bold mb-3 text-blue-900 dark:text-blue-300">Abstract</h3>
            ...
            {article.keywords && article.keywords.length > 0 && (
              <div>
                <h3 className="text-lg font-serif font-bold mb-3 text-blue-900 dark:text-blue-300">Keywords</h3>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <h3 className="text-lg font-serif font-bold mb-3 text-blue-900 dark:text-blue-300">How to Cite</h3>
              <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-md border border-blue-200 dark:border-blue-900">
                <p className="text-sm font-semibold text-blue-600 dark:text-blue-400 mb-2">APA Citation:</p>
