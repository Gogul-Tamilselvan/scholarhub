...
const articles: Record<string, Article> = {
  ...
  "sjhss-v1i2-002": {
    ...
    affiliation:
      "1. Assistant Professor, Department of MBA, School of Management Studies, Vels Institute of Science Technology & Advanced Studies (VISTAS), Pallavaram, Chennai, Tamil Nadu, India",
    pages: "09 – 14",
    volume: "1",
    issue: "2",
    year: "2026",
